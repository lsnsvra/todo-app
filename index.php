...
<div class="container py-5">
    <div class="row mb-4">
        ...
        <div class="col-md-4 text-end">
            <a href="tasks/form.php" class="btn btn-primary btn-lg me-2"><i class="bi bi-plus-circle me-1"></i>Tambah Task</a>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <?php endif; ?>
                                    <a href="#" onclick="showDeleteModal(<?= $t['id'] ?>, '<?= htmlspecialchars(addslashes($t['title'])) ?>')" class="btn btn-outline-danger btn-sm">
